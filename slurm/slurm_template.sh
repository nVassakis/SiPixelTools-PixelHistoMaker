...
git clone --branch fixed_bugs_slurm_updated https://github.com/nVassakis/SiPixelTools-PixelHistoMaker.git SiPixelTools/PixelHistoMaker
...
cd ../../../..
rm -rf CMSSW CMSSW_15_0_15_patch4
