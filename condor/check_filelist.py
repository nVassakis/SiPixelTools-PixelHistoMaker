...
import os, sys, subprocess, random, shutil, operator, time, ROOT
        ...
        while not all_ok and nretry<3:
            if filename == "":
                ...
                if "root://cms-xrd-global.cern.ch/" in chkfile:
                    ...
                    os.system("xrdcp "+chkfile+" "+localfilename)
                    time.sleep(1)
            ...
            if not fin:
                ...
                if not tree:
                    ...
                    if entries==0:
                        ...
                        print "  --> Tree has entries: "+str(entries)
                        all_ok = True
                        #if filename != chkfile: all_ok = True
                fin.Close()
            readtime = timer()-starttime
            print "  --> Time of read test: "+str(readtime)
            if all_ok:
                if filename == chkfile:
                    nfileok += 1
                print "  --> Save: "+filename
