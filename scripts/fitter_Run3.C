...
void fitter_Run3() {
  ...
  float maxfit = 14;
  TF1 *fit_l1_in  = new TF1("fit_l1_in", "pol1",0,maxfit);
  TF1 *fit_l1_out = new TF1("fit_l1_out","pol1",0,maxfit);
  ...
  // Get dcol efficiency
  TF1 *dcol_l1_in  = new TF1("dcol_l1_in", "pol1",0,25);
  TF1 *dcol_l1_out = new TF1("dcol_l1_out","pol1",0,25);
