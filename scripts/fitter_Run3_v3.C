void fitter_Run3_v3() {
  ...
  TF1 *fit_l1_in  = new TF1("fit_l1_in", "pol3",0,25);
  TF1 *fit_l1_out = new TF1("fit_l1_out","pol3",0,25);
  TF1 *fit_l2 = new TF1("fit_l2","pol3",0,25);
  ...
  TF1 *dcol_l2 = new TF1("dcol_l2","pol3",0,25);
  ...
  leg->Clear();
  leg->SetNColumns(2);
  leg->SetHeader("v3, L1 3rd order polinomial");
