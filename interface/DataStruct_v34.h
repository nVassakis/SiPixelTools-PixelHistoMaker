...
#ifdef COMPLETE
    list="validhit/I:missing:lx/F:ly:clust_near/I:hit_near:pass_efcuts:"
      "nclu_mod:nclu_roc:npix_mod:npix_roc:alpha/F:beta:dx_cl[2]:dy_cl[2]:"
      "dx_hit:dy_hit:norm_charge:lz:glx:gly:glz:lxmatch:lymatch:i/I:"
